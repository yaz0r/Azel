...
{
    dragonFieldTaskInitSub3Sub1(&pDragonState->dragon3dModel, pDragonState->pDragonModelRawData + READ_BE_U32(pDragonState->pDragonModelRawData + pDragonState->dragonAnimOffsets[param2]));
